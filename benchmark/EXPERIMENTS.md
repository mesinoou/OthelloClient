...
| RUNTIME-001 | running | `baseline/multi-probcut-20260721` | `codex/runtime-auto-sizing` | 接続前診断でthreadsとTT容量だけを自動選択 | `benchmark/ALGORITHM_ROADMAP.md#runtime-001-environment-profiling-and-auto-sizing` | 2026-07-22に実装開始 | 固定済み契約で検証中 |
