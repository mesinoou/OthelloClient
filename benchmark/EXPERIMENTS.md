...
| EVAL-020 | held | EVAL-018 held candidate | `codex/eval-020-broad-l11-white-ranking` | 実戦L8白50局の全兄弟手10,903件をEdax L11で再採点し、phase 0 WLD順位補正を25%へ縮小 | `benchmark/results/eval-020-broad-l11-white-ranking-2026-07-24.md` | 未見WLD降格率は現行と同値、固定深さ8白は50.0%対現行40.0%、Edax L11白8局は双方25.0%で石差のみ+1.25 | 改善方向はあるがL11 8局では不足。白番限定のheld候補として保存し大会用モデルへ未統合 |
