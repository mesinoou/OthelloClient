...
| CLIENT-001 | running | `baseline/runtime-auto-sizing-20260722` | `codex/opponent-turn-pondering` | 相手手番探索で共有TTだけを予熱 | `benchmark/ALGORITHM_ROADMAP.md#client-001-opponent-turn-pondering` | 2026-07-22に実装開始 | 既定off、ratio 0.80、盤面freshness、送信権限分離の固定契約で検証中 |
