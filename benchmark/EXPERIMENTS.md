...
| SEARCH-010 | rejected | `baseline/exact-last-n-20260721` | `codex/enhanced-tt-cutoff` | 十分深い子局面TT boundによる安全なbeta cutoff | `benchmark/results/search-010-enhanced-tt-cutoff-2026-07-21.md` | 4T node削減0.32〜1.54%、500 ms深度同値、不一致0/352 | 性能ゲート未達のため実験ブランチへ保存 |
