...
| EVAL-013 | rejected | `751e459` | `codex/eval-013-lmr-bucket-ordering` | LMRの先頭手とindex 4境界を維持し、各group内だけEVAL-010反復2で再整列 | `benchmark/results/eval-013-lmr-bucket-ordering-2026-07-23.md` | 閾値7は深さ9で時間-0.72%、別seed深さ10でnode -3.47%・時間-4.36% | 事前5%速度ゲート未達のため対局前に停止 |
