...
| SEARCH-011 | running | `baseline/exact-last-n-20260721` | `codex/stability-cutoff` | edge stable discsによる終盤window縮小 | `benchmark/ALGORITHM_ROADMAP.md` | 実装準備中 | L0-L3、L5、L7で判定 |
