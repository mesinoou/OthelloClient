...
| SEARCH-010 | running | `baseline/exact-last-n-20260721` | `codex/enhanced-tt-cutoff` | 十分深い子局面TT boundによる安全なbeta cutoff | `benchmark/ALGORITHM_ROADMAP.md` | 実装準備中 | L0-L3、L5、L7で判定 |
