...
| EVAL-014 | rejected | `751e459` | `codex/eval-014-pattern-residual-audit` | 既存6-patternのEdax残差に対し5候補形状を同一小型MLPで比較 | `benchmark/results/eval-014-pattern-residual-audit-2026-07-23.md` | 3探索葉分布でedge8はMSEを2.56〜3.58%、corner2x5は2.68〜3.88%改善したが、既存corner3x3再学習対照も2.57〜4.52%改善 | 追加形状固有の改善が分布をまたいで再現せず、runtime形式変更前に停止。監査基盤のみ保存 |
