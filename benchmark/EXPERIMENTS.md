...
- `held`: 最終gate未達だが改善根拠があり、後続改善の比較基準として保持する候補
- `accepted`: 基準版への統合対象
...
| TOURNEY-001 | infrastructure | `846d7dd` | `codex/tournament-white-config-20260724` | 色別評価モデル選択を追加し、白番改善構成を大会前に短時間検証 | `benchmark/results/tournament-001-white-model-selection-2026-07-24.md` | L8は色別構成36.5%対標準30.5%・held33.5%。L11は白25.0%、総合37.5%。実サーバ2局完走 | 色別機能は任意機能として保持。大会はheld単一モデル、8秒、定石on、ponder off |
| ANALYSIS-001 | infrastructure | `89d7eff` | `codex/white-loss-analysis-20260724` | EVAL-018の白番敗局を開始局面biasと全兄弟手Edax regretへ分解 | `benchmark/results/analysis-001-white-loss-causes-2026-07-24.md` | 中立L11 openingでも黒56.25%・白25.0%。2秒再現10敗の最初のW/D/L downgradeはphase 0-1、phase 3は0件 | trace・色/opening選択・兄弟手解析基盤を採用。次学習は強い黒への白応手とphase 0-1順位を優先 |
...
| EVAL-018 | held | `aac1d7f` | `codex/eval-018-l11-formal-gate` | phase 3無効化候補を大会条件Edax L11・50 opening pairで正式評価 | `benchmark/results/eval-018-l11-formal-gate-2026-07-23.md` | L11は44-3-53、score 45.5% CI `[38.5,52.5]%`。L8では標準比score +5.0 point、石差+1.91 | L11絶対gateは不通過。標準runtimeへ未統合のまま、後続改善の基準候補として保持 |
| EVAL-019 | rejected | EVAL-018 held candidate | `codex/eval-019-white-response-ranking` | 白敗因解析に基づき、強い黒への白応手兄弟局面をWLD優先でphase 0-1の量子化補正へ学習 | `benchmark/results/eval-019-white-response-ranking-2026-07-24.md` | 未見順位は改善し候補白は現行黒へ57.5%だが、新規openingのEdax L11白8局は0%対現行25%、L8混合版も未見WLD降格率が悪化 | 学習・評価基盤は保存。候補は過適合のため不採用、広い全結果白局面を同品質L11採点して再試験 |
| EVAL-020 | accepted | EVAL-018 held candidate | `codex/eval-020-broad-l11-white-ranking` | 実戦L8白50局の全兄弟手10,903件をEdax L11で再採点し、phase 0 WLD順位補正を25%へ縮小 | `benchmark/results/eval-020-broad-l11-white-ranking-2026-07-24.md` | 未見WLD降格率は現行と同値、固定深さ8白は50.0%対現行40.0%、Edax L11白8局は双方25.0%で平均石差+1.25 | TOURNEY-002で白番限定採用。黒番はEVAL-018 heldを維持 |
| TOURNEY-002 | accepted | TOURNEY-001 | `codex/tournament-eval020-s25-20260724` | 黒EVAL-018 held・白EVAL-020 25%補正を大会構成として固定 | `benchmark/results/tournament-002-eval020-white-adoption-2026-07-24.md` | 固定深さ8白+10.0 point、短いEdax L11白は勝率同値・平均石差+1.25 | 改善幅と検証数の限界を承知して白番限定採用。SHA固定、ponder off |
