...
| EVAL-011 | rejected | `751e459` | `codex/eval-011-root-ordering-model` | EVAL-010反復2を非終盤ルート手の順序付けだけに使用 | `benchmark/results/eval-011-root-ordering-model-2026-07-23.md` | 深さ9の32局面でbest move・score一致32/32、総node -0.012%、時間+0.390% | 効果量が実質0のため時限制・Edax試験へ進めず不採用 |
