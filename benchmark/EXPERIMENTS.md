...
| EVAL-012 | rejected | `751e459` | `codex/eval-012-upper-node-ordering` | EVAL-010反復2で残り深さ7以上の内部nodeを順序付け | `benchmark/results/eval-012-upper-node-ordering-2026-07-23.md` | 深さ10 node -13.66%、500ms深さ+0.16〜0.22だがEdax L8は34.5%・石差-10.73対現行37.5%・-9.28 | LMRの削減対象を誤誘導して棋力が悪化したため不採用 |
