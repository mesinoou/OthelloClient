...
| RUNTIME-001 | specified | `baseline/multi-probcut-20260721` | `codex/runtime-auto-sizing` | 接続前診断でthreadsとTT容量だけを自動選択 | `benchmark/ALGORITHM_ROADMAP.md#runtime-001-environment-profiling-and-auto-sizing` | 2026-07-22にCLI、上書き優先順位、2秒上限、fallbackを固定 | 次の実装対象 |
| CLIENT-001 | specified | RUNTIME-001採用版 | `codex/opponent-turn-pondering` | 相手手番探索で共有TTだけを予熱 | `benchmark/ALGORITHM_ROADMAP.md#client-001-opponent-turn-pondering` | 2026-07-22に既定off、ratio 0.80、盤面freshness、送信権限分離を固定 | RUNTIME-001判定後に実装 |
