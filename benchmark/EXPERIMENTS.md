...
| CLIENT-001 | specified | RUNTIME-001採用版 | `codex/opponent-turn-pondering` | 相手手番探索で共有TTだけを予熱 | `benchmark/ALGORITHM_ROADMAP.md#client-001-opponent-turn-pondering` | 2026-07-22に既定off、ratio 0.80、盤面freshness、送信権限分離を固定 | RUNTIME-001統合後に実装 |
